const ESTIMATED_FOODS = [
  {
    name: 'Chicken Wings',
    patterns: [/\bchicken wings?\b/, /\bwings?\b/, /\baripi(?: de pui)?\b/],
    unit: /wings?|pieces?|buc(?:ati|ăți)?|aripi/,
    gramsPerUnit: 30,
    macrosPerUnit: { calories: 61, protein: 6.4, carbs: 0, fat: 4.1 },
    per100g: { calories: 203, protein: 21.3, carbs: 0, fat: 13.7 },
  },
  {
    name: 'Rice Cakes',
...
export function estimateFoodFromText(line, foodName = '', defaultGrams = 100) {
  const haystack = autocorrect(`${line} ${foodName}`);
